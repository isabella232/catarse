  ...
  def name
    deliver = %{
      <div class="fontsize-smallest fontcolor-secondary">
        Delivery Estimates:&nbsp;#{source.display_deliver_estimate || I18n.t('projects.contributions.no_estimate')}
      </div>
    }
    %{
      ...
      <div class="w-row back-reward-money w-hidden">
        <div class="w-col w-col-8 w-col-small-8 w-col-tiny-8 w-sub-col-middle w-clearfix">
          ...
          <div class="fontsize-smaller text-error u-marginbottom-20 w-hidden"><span class="fa fa-exclamation-triangle"></span> Your contribution value is incorrect</div>
        </div>
